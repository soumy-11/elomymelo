  ...
  { 
    ...
    divTmr = setTimeout(function() { const element = document.querySelector('.art-text-div'); console.log('article-div-scrolled');
  ...
  function articleDiv()
  {
    ...
    if (window.matchMedia("(min-width: 615px)").matches && Notification.permission === 'default' && (noticounter <= 1 || noticounter > 5)) { com2 = true; 
