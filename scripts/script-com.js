  ...
  function notiOverlay()
  {
    ...
    || (Notification.permission === 'default' && noticounter > 5)) 
    {
        ...
        notistyle.innerHTML = '.noti-overlay{position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.5);z-index:1000}.noti-main{position:absolute;left:0;right:0;top:0;bottom:0;margin:auto;width:75%;height:max-content;text-align:center;color:rgba(255,255,255,0.5);font-family:roboto,sans-serif;border-radius:20px;background:black}.top-img{position:relative;margin-top:40px;width:105px;margin-bottom:25px;border:4px #545454 solid;border-radius:90px;left:0;right:0;margin-left:auto;margin-right:auto;padding:10px 10px 6px 10px}.mid-text{position:relative;margin-top:5px;width:90%;margin-bottom:5px;border:3px #545454 solid;border-radius:15px;color:#b9b9b9;font-size:14px;line-height:20px;left:0;right:0;margin-left:auto;margin-right:auto;padding:16px}.act-buttons{position:relative;margin-top:10px;width:200px;margin-bottom:30px;border-radius:40px;left:0;right:0;margin-left:auto;margin-right:auto;text-align:center}.noti-button{position:relative;padding:15px 25px 15px 25px;background:#464646;color:#b0b0b0;border-radius:40px;font-size:14px;margin:15px;cursor:pointer}';
